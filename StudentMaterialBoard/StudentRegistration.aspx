        ...
        <div class="agile-field-txt">
				<label>
					...
					<asp:DropDownList ID="ddlDept" runat="server">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Select Department" InitialValue="--Select--" ValidationGroup="A" ControlToValidate="ddlDept" ForeColor="#fb0b57"></asp:RequiredFieldValidator>
